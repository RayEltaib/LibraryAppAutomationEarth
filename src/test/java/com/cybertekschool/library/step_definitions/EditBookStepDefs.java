...
public class EditBookStepDefs {
    ...
    public void the_user_edit_the_book_using_following_info(Map<String,Object> map) {
        ...
        response = given().header("x-library-token",accessToken).body(map).when().patch(Endpoints.UPDATE_BOOK);
...
//        String message = json.getString("message");
 //       Assert.assertEquals("The book has been updated.",message);
    ...
    public void the_book_info_should_be_changed_to_as_the_following(Map<String,Object> map) {
